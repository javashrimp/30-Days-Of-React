...
![30 Days of React banner](https://github.com/Asabeneh/30-Days-Of-React/blob/master/images/30_days_of_react_banner_day_3.jpg)
...
```sh
Izo@guru MINGW64 ~/Desktop/30-days-of-react (master)
\$ npm start
```
